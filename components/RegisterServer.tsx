...
export default async function RegisterServer() {
  const earthquakeresponse = await fetch('http://localhost:3000/data/earthquake-area.json');
  ...
  const tsunamiresponse = await fetch('http://localhost:3000/data/tsunami-area.json');
  ...
  const tyhoonresponse = await fetch('http://localhost:3000/data/tyhoon-area.json');
